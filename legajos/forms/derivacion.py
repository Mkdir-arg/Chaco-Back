...
class DerivarProgramaForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["institucion_programa"].queryset = Programa.objects.filter(estado=Programa.Estado.ACTIVO).order_by(
            "nombre"
        )
    ...
    def clean(self):
        ...
        if programa_destino and tipo_inicio == "inscripcion_directa":
            ...
            if existe_inscripcion:
                self.add_error(
                    "institucion_programa", "El ciudadano ya tiene una inscripción activa o pendiente en este programa."
                )
