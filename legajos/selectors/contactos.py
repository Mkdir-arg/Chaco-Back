            ...
            actividades.append(
                {
                    ...
                    "tipo": "APERTURA",
                    "descripcion": ("Acompañamiento abierto en programa vigente"),
    ...
    if VinculoFamiliar:
        for vinculo in VinculoFamiliar.objects.filter(ciudadano_principal=ciudadano):
            actividades.append(
                {
                    "fecha_hora": (
                        vinculo.creado.isoformat() if hasattr(vinculo, "creado") else datetime.now().isoformat()
                    ),
                    "tipo": "VINCULO",
                    "descripcion": (
                        "Vínculo agregado: "
        ...
        eventos.append(
            {
                ...
                "tipo": "APERTURA",
                "titulo": "Apertura de Acompañamiento",
                "descripcion": ("Acompañamiento iniciado"),
                "legajo_id": str(legajo.id),
            }
        )
            ...
            eventos.append(
                {
                    ...
                    "tipo": "EVALUACION",
                    "titulo": "Evaluación Inicial",
                    "descripcion": (f"Evaluación realizada - Nivel de riesgo: {legajo.nivel_riesgo}"),
                    "legajo_id": str(legajo.id),
                }
            )
