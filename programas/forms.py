...
class PreguntaGlobalForm(_OrdenUnicoMixin, _PresentacionMixin, _OpcionesMixin):
    ...
    def clean(self):
        """Una sola pregunta **activa** por destino SIIS: si hubiera dos, el
        payload no sabría cuál respuesta tomar. MySQL no soporta constraints
        condicionales, así que la regla vive acá."""
        cleaned = super().clean()
