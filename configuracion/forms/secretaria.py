...
class SecretariaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "nombre": forms.TextInput(attrs={"class": _FIELD_CLASS, "placeholder": "Ej: Secretaría de Desarrollo Social"}),
            "descripcion": forms.Textarea(attrs={"class": _FIELD_CLASS, "rows": 3, "placeholder": "Descripción opcional"}),
        }
