...
urlpatterns = [
    ...
    path(
        "mi-perfil/mis-datos/confirmar-email/<uuid:token>/", ciudadano_confirmar_email, name="ciudadano_confirmar_email"
    ),
    ...
    path(
        "mi-perfil/password/reset/enviado/",
        CiudadanoPasswordResetDoneView.as_view(),
        name="ciudadano_password_reset_done",
    ),
    path(
        "mi-perfil/password/reset/<uidb64>/<token>/",
        CiudadanoPasswordResetConfirmView.as_view(),
        name="ciudadano_password_reset_confirm",
    ),
    path(
        "mi-perfil/password/reset/completado/",
        CiudadanoPasswordResetCompleteView.as_view(),
        name="ciudadano_password_reset_complete",
    ),
]
