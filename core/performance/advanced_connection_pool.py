...
class AdvancedConnectionPool:
        ...
        try:
            ...
            for db_alias, db_config in db_configs.items():
                if db_config["ENGINE"] == "django.db.backends.mysql":
                    self.pools[db_alias] = DatabasePool(db_alias=db_alias, db_config=db_config, pool_config=self.config)
    ...
    def _update_query_stats(self, execution_time: float):
        ...
        with self.lock:
            ...
            self.stats["avg_response_time"] = (current_avg * (query_count - 1) + execution_time) / query_count
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            return {"global_stats": self.stats.copy(), "pool_stats": pool_stats, "timestamp": time.time()}
