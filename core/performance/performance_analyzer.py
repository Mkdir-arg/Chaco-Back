...
class PerformanceAnalyzer:
    ...
    def analyze_queries(self, queries):
        ...
        results = {"total_queries": len(queries), "n1_detected": False, "similar_queries": 0, "recommendations": []}
    ...
    def generate_report(self):
        ...
        report = {
            ...
            "session_info": {"total_session_queries": len(connection.queries), "recent_activity": len(queries)},
        }
