...
| # | Funcionalidad | Prioridad | Estado al 16/09 | Hs aprobadas | Ejecutado |
|:-:|---|:-:|:-:|:-:|:-:|
| 1 | Constructor de formularios por convocatoria | Alta | **En pruebas** — integrado a la rama de trabajo el 15/09, en DEV y en QA | 270 h | **251 h 30 min (93%)** |
...
## :material-chart-timeline-variant: Avance al 16/09/2026

**480 h** de trabajo en lo que va de la versión, con el equipo completo. Lo que se movió:
...
- **Constructor de formularios: 251 h 30 min de 270 (93%)**. El backoffice y el link público quedaron terminados, y el **15/09 el constructor se integró con todo lo publicado desde fin de agosto** y pasó al ambiente de pruebas del organismo. **Quedan 18 h 30 min**, y adentro está la adaptación de la app de campo: es el frente a vigilar del mes.
