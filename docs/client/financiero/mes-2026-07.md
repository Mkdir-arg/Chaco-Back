...
!!! info "Mes en curso"
    Julio 2026 está en ejecución. Al **31/07** se llevan **424 h 55 min consumidas** sobre un presupuesto de **500 horas** (85%). Esta página se actualiza a medida que se registran horas.
...
| [Programa Dispositivos](../funcionalidades/programa-dispositivos.md) (incluye Merenderos) | 225.0 | 53% |
| Transversal (gestión, reuniones, soporte, video) | 73.8 | 17% |
| **Total julio 2026 (al 31/07)** | **424.9** | **100%** |
...
|---|---|---:|---:|
| Juani Portilla | Desarrollo backend de Dispositivos y Merenderos; refinamiento y permisos de Becas; listado de Usuarios, filtros de Roles y performance transversal | 205.5 | 48% |
