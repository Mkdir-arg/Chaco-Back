...
!!! info "Regularización de horas (02/07/2026)"
    El cierre incluye **300 horas** trabajadas entre el 23/06 y el 30/06 que se consolidaron en el registro el 02/07 (front de la app de campo, backend de Becas, análisis del programa Dispositivos y mockups del equipo UX). El detalle por día está en el [registro de consumo](detalle-tareas.md).
